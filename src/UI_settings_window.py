...
class Ui_Settings(object):
    def setupUi(self, Settings, parent=None):
        ...
        self.gridLayout.addWidget(self.rigol_oscilloscope_address_label, 4, 0, 1, 1)
        ...
        # )
        self.gridLayout.addWidget(self.rigol_oscilloscope_address_lineEdit, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.software_settings_header_label, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.header_line_3, 7, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.default_saving_path_label, 8, 0, 1, 1)
